...
const Chat = ({ users, setUnread }) => {
    ...
    const { player, gameId, url, chat, setChat } = useContext(GlobalContext);
    ...
    return (
        <div className='flex flex-col w-screen max-w-lg relative'>
            ...
            <div className="chats w-full max-h-[65vh] overflow-auto mt-13 mb-15 p-2 bg-[#1a1b20] flex flex-col gap-1 scrollbar-hidden">
            ...
            <div className='flex items-center px-2  gap-1.5 fixed bottom-3 w-full max-w-lg bg-[#1a1b20] z-10'>
                ...
                />
                <button className='p-3.5 transition rounded-full active:bg-[#3b52fa98] ' style={{ backgroundColor: inputs.chatContent ? '#3b52fa' : '#262a35' }} onClick={handleSendMsg}>
